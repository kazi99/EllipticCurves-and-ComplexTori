...
% $((V_i, \olsi{\varphi}_i))_{i \in I}$.


% Z upoštevanjem komutativnih diagramov \eqref{projektivna karta diagram} in \eqref{projektivna karta v inf diagram} izračunamo
% \begin{align*}
...
% \end{align*}
% Kadar je $U_i \subseteq E$ graf holomorfne funkcije $\phi_i$ nad prvo koordinato $x$, je 
% \begin{align*}
%     (\varphi'_\infty \circ {\varphi'_i}\inv)(z) &= 
%     \varphi'_\infty(z, \phi_i(z), 1) = 
%     z \quad \text{za vsak $z \in \olsi{\varphi}_i(V_\infty \cap V_i)$ in}\\
%     (\varphi'_i \circ {\varphi'_\infty}\inv)(z) &=
%     \varphi'_i(z, 1, \phi_\infty(z)) = 
% \end{align*}

% $\varphi'_i : U_i \subseteq \C^2 \to \C$
